...
public class RoadController {
    ...
    //высота КПП уменьшена с 4000 до 3500, что соответствует значниею 3,5 метра
    ...
    private static int calculatePrice(Car car) {
        ...
        if (carHeight > controllerMaxHeight) {
            ...
            //Грузовой автомобиль
            /** при расчете цены для грузового автомобиля, вес которого больше, чем вес легкового
             *  использовалась переменная цены, предназначенная для легкового автомобиля. Исправлено.
             */
